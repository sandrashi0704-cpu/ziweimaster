  ...
  return (
    <div className="space-y-0.5">
      {lines.map((line, i) => {
        ...
        if (sectionMatch) {
          return (
            <div key={i} className="pt-3 pb-0.5 first:pt-0">
              <span className="text-[16px] font-semibold tracking-wide" style={{ color: 'var(--t-gold)' }}>
                【{sectionMatch[1]}】
              </span>
            </div>
          );
        ...
        return (
          <div key={i} className="text-[16px] leading-relaxed" style={{ color: 'var(--t-text2)' }}>
            {parts.map((part, j) =>
              j % 2 === 0
                ? part
          ...
          {TOPICS.map(t => {
            ...
            return (
              <button
                ...
                disabled={loading}
                className="py-2.5 text-[20px] font-medium rounded-lg transition-all duration-150 disabled:opacity-40"
                style={{
      ...
      <div ref={scrollRef} className="flex-1 overflow-y-auto p-4 space-y-4 min-h-0">
        ...
        {messages.length === 0 && (
          <div className="flex flex-col items-center justify-center h-full text-center">
            ...
            <p className="text-[19px] animate-pulse" style={{ color: 'var(--t-faint)' }}>命格解读生成中…</p>
          </div>
        )}
          ...
          {messages.map((msg, i) => {
            ...
            if (msg.role === 'user') {
              return (
                ...
                >
                  <div
                    className="max-w-[85%] rounded-xl px-4 py-3 text-[20px]"
                    style={{
            ...
            return (
              ...
              >
                <div
                  className="text-[18px] tracking-widest mb-2 flex items-center gap-1.5"
