          ...
          {messages.map((msg, i) => {
            ...
            if (msg.role === 'user') {
              return (
                ...
                >
                  <div
                    className="max-w-[85%] rounded-xl px-4 py-3 text-[14px]"
                    style={{
            ...
            return (
              ...
              >
                <div
                  className="text-[11px] tracking-widest mb-2 flex items-center gap-1.5"
      ...
      <div className="flex-shrink-0 px-3 pb-3 pt-2" style={{ borderTop: '1px solid var(--t-border)' }}>
        <div className="flex gap-2">
          <input
            ...
            disabled={loading}
            className="flex-1 rounded-lg px-4 py-3 text-[14px] focus:outline-none transition-colors"
            style={{
          ...
          <button
            ...
            className="px-4 py-3 rounded-lg text-[14px] font-medium transition-all disabled:opacity-30 disabled:cursor-not-allowed"
            style={{
