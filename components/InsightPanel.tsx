          ...
          {TOPICS.map(t => {
            ...
            return (
              <button
                ...
                disabled={loading}
                className="py-2.5 text-[15px] font-medium rounded-lg transition-all duration-150 disabled:opacity-40"
                style={{
      ...
      <div ref={scrollRef} className="flex-1 overflow-y-auto p-4 space-y-4 min-h-0">
        ...
        {messages.length === 0 && (
          <div className="flex flex-col items-center justify-center h-full text-center">
            ...
            <p className="text-[14px] animate-pulse" style={{ color: 'var(--t-faint)' }}>命格解读生成中…</p>
          </div>
        )}
          ...
          {messages.map((msg, i) => {
            ...
            if (msg.role === 'user') {
              return (
                ...
                >
                  <div
                    className="max-w-[85%] rounded-xl px-4 py-3 text-[15px]"
                    style={{
            ...
            return (
              ...
              >
                <div
                  className="text-[13px] tracking-widest mb-2 flex items-center gap-1.5"
      ...
      <div className="flex-shrink-0 px-3 pb-3 pt-2" style={{ borderTop: '1px solid var(--t-border)' }}>
        <div className="flex gap-2">
          <input
            ...
            disabled={loading}
            className="flex-1 rounded-lg px-4 py-3 text-[15px] focus:outline-none transition-colors"
            style={{
          ...
          <button
            ...
            className="px-4 py-3 rounded-lg text-[15px] font-medium transition-all disabled:opacity-30 disabled:cursor-not-allowed"
            style={{
